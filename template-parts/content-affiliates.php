...
================================================== -->
	...
	<?php if(has_post_thumbnail()) : ?>
		<section class="feature-image feature-image-default" style="background: url('<?= $thumbnail_url ?>') no-repeat; background-size: cover" data-type="parallax" data-speed-factor="4">
